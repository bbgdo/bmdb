...
export class UpdateMovieInput {
  @Field({ nullable: true }) @IsOptional() @IsString() @MinLength(1) @MaxLength(200) title?: string
  @Field({ nullable: true }) @IsOptional() @IsString() @MinLength(10) description?: string
  @Field(() => Int, { nullable: true }) @IsOptional() @Type(() => Number) @IsInt() @Min(1888) @Max(2100) releaseYear?: number
