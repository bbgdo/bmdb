...
export class AuthService {
	...
	register = async (dto: RegisterDto): Promise<{ message: string }> => {
		...
		console.log(`\n\x1b[43m\x1b[30m [DEMO VERIFICATION LINK] \x1b[0m http://${this.config.get('FRONTEND_URL', 'localhost:3000').replace(/^https?:\/\//, '')}/verify-email?token=${verifyToken}\n`)
